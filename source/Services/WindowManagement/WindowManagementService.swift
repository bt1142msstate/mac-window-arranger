...
struct WindowManagementService {
    ...
    func frames(for layoutKind: LayoutKind) -> [CGRect] {
        ...
        return layoutFrameService.frames(for: layoutKind, in: visibleFrame)
    }
    ...
    func nonOverlappingFrames(forVisibleWindowCount count: Int) -> [CGRect] {
        ...
        return layoutFrameService.nonOverlappingFrames(forVisibleWindowCount: count, in: visibleFrame)
    }
